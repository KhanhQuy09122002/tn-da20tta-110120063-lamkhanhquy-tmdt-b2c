...
<div class="shop-register-form">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <?= $form->field($model, 'logo_shop')->fileInput(['class' => 'form-control']) ?>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                <?= $form->field($model, 'business_license')->fileInput(['class' => 'form-control']) ?>
            </div>

            <?= $form->field($model, 'status')->hiddenInput(['value' => '1'])->label(false) ?>
            <?= Html::hiddenInput('register', '1') ?>
            
            <div class="col-12 text-center">
                <?= Html::submitButton('Đăng ký', ['class' => 'btn btn-primary btn-flat m-b-30 m-t-30']) ?>
            </div>
